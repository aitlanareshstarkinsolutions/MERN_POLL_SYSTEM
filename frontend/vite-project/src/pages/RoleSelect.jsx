    ...
    <div className="flex justify-center min-h-screen pt-10 bg-white">
      <div className="max-w-custom w-full px-4 flex flex-col items-center">
        ...
        <div className="flex gap-6 justify-center w-full mb-8">
          {/* Student */}
          <div
            className={`flex-1 min-w-[260px] p-6 rounded-xl border-2 shadow-md cursor-pointer transition-all 
              ${selectedRole === "student" ? "border-blue-500 shadow-lg" : "border-purple-200 hover:border-blue-500 hover:shadow-lg"}`}
          ...
          <div
            className={`flex-1 min-w-[260px] p-6 rounded-xl border-2 shadow-md cursor-pointer transition-all 
              ${selectedRole === "teacher" ? "border-blue-500 shadow-lg" : "border-purple-200 hover:border-blue-500 hover:shadow-lg"}`}
        ...
        {/* Continue button */}
        <button
          className="mt-6 px-16 py-2 text-lg text-white rounded-full bg-gradient-to-r from-purple1 to-purple2 hover:opacity-90 transition"
